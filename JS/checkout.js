...
function showCreditCardInput() {
    ...
    if (online_pay.checked && online_pay.value === "online") {
        credit_card_input.style.display = "block";
    } else {
        credit_card_input.style.display = "none";
    }
}
// 輸入卡號
...
// 條碼載具
function showInput() {
    let selectBox = document.getElementById("invoice");
    let selectedValue = selectBox.options[selectBox.selectedIndex].value;
    if (selectedValue == "carrier") {
        document.getElementById("carrier_number").style.display = "flex";
    } else {
        document.getElementById("carrier_number").style.display = "none";
    }
}
