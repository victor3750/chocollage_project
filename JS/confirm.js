...
addToCart.on('click', function (e) {
    ...
    // flyingImg.css('width', window.matchMedia('(max-width: 576px)').matches ? '50' : '100').css('height', window.matchMedia('(max-width: 576px)').matches ? '50' : '100');
    flyingImg.css('width','100').css('height', '100');
